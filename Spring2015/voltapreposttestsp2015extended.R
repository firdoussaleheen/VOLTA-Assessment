...
#set directory
setwd("D:/RESEARCH/TempleVLA/Data Analysis/Spring2015") 

#import data into workspace
volta <- read.csv("Students_Score_Spring2015_v2.csv", header=TRUE)
...
#write.csv(voltasplit$Control, file = "voltacontrol_spring2015_v1.csv")
#write.csv(voltasplit$Experimental, file = "voltaexperimental_spring2015_v1.csv")
#write.table(voltasplit$Control, file = "voltacontrol_spring2015_v1.txt", sep = "\t")

voltacontrol <- read.csv("voltacontrol_spring2015_v1.csv", header=TRUE)
voltaexperimental <- read.csv("voltaexperimental_spring2015_v1.csv", header=TRUE)
...
library(Cairo)
tiff(filename="testscorespring2015.tiff", width = 10, height = 7, units = 'in', res = 300, 
